<?php
    function assign_rand_value($num) {
        switch($num) {
            ...
            case "63" : $rand_value = "!"; break;
            case "64" : $rand_value = "£"; break;
            case "65" : $rand_value = "$"; break;
            case "66" : $rand_value = "%"; break;
            case "67" : $rand_value = "&"; break;
            case "68" : $rand_value = "*"; break;
            case "69" : $rand_value = "#"; break;
    ...
    function get_rand_alphanumeric_maiusc($length) {
        if ($length>0) {
            $rand_id="";
            for ($i=1; $i<=$length; $i++) {
                mt_srand((double)microtime() * 1000000);
    ...
    function get_rand_maiusc($length) {
        if ($length>0) {
            $rand_id="";
            for($i=1; $i<=$length; $i++) {
                mt_srand((double)microtime() * 1000000);
    ...
    function get_rand_symbol($length) {
        if ($length>0) {
            $rand_id="";
            for($i=1; $i<=$length; $i++) {
                mt_srand((double)microtime() * 1000000);
